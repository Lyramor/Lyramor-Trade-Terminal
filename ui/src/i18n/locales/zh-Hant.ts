...
export const zhHant: Resources = {
  ...
  settings: {
    ...
    snapshot: {
      title: '快照',
      description: '伺服器記錄帳戶狀態（權益、餘額、持倉）的頻率。這是錄製排程，不是圖表篩選器。它不會改變投資組合圖表顯示的內容，只決定圖表有多少歷史資料可畫。它原本就在那張圖表下方，看起來像是區間選擇器，這正是它現在放到這裡的原因。',
    },
    persona: {
      title: '人設',
  ...
  market: {
    ...
    macroSince: '起點',
    macroClose: '關閉',
    macroFullHistory: '此面板始終顯示全部歷史，不受看板日期區間的影響，所以最小、最大和起點可能與卡片不一致。',
    macroBoardRange: '看板區間：{{from}} → {{to}}',
    colValue: '數值',
    noData: '暫無資料',
    showMoreResults: '顯示更多結果',
    resultsTruncated: '僅顯示前 {{shown}} 筆結果。縮小搜尋範圍可看到其餘結果。',
  },
  portfolio: {
    overview: '總覽',
    allAccounts: '所有帳戶',
  ...
  templates: {
    ...
    communityDescription:
      '第三方生態的打包模板——建立工作區時從上游倉庫全新 clone，由原作者維護，而非 Lyramor。',
    communityBadge: '社群',
    agentsLabel: 'Agents',
