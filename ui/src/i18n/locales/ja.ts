...
export const ja: Resources = {
  ...
  settings: {
    ...
    snapshot: {
      title: 'スナップショット',
      description: 'サーバーが口座の状態（エクイティ・残高・保有ポジション）を記録する頻度です。これは記録のスケジュールであり、チャートのフィルターではありません。ポートフォリオのチャートに表示される内容が変わることはなく、チャートが描ける履歴の量が決まるだけです。以前はそのチャートのすぐ下にあり、期間の切り替えのように見えていました。だからこそ、今はここに置かれています。',
    },
    persona: {
      title: 'ペルソナ',
  ...
  market: {
    ...
    rangeTo: '終了',
    rangeAll: '全期間',
    rangeInvalid: '開始日が終了日より後になっています。',
    macroLatest: '最新',
    macroChange: '変化',
    macroMin: '最小',
    macroMax: '最大',
    macroSince: '開始',
    macroClose: '閉じる',
    macroFullHistory: 'このパネルは常に全期間を表示し、ボードで選んだ期間は適用されません。最小・最大・開始がカードと異なることがあります。',
    macroBoardRange: 'ボードの期間: {{from}} → {{to}}',
    colValue: '値',
    noData: 'データなし',
    showMoreResults: 'さらに表示',
    resultsTruncated: '上位 {{shown}} 件のみ表示しています。絞り込むと残りも見られます。',
  },
  portfolio: {
    overview: '概要',
    allAccounts: '全アカウント',
  ...
  templates: {
    ...
    communityDescription:
      'サードパーティのエコシステムをまとめたテンプレート — ワークスペース作成時に上流リポジトリから新規 clone され、Lyramor ではなく各作者がメンテナンスしています。',
  ...
  auth: {
    heading: 'Lyramor にサインイン',
    instruction: 'ユーザー名とパスワードでサインインしてください。',
