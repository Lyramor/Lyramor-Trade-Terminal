...
export const zh: Resources = {
  ...
  settings: {
    ...
    snapshot: {
      title: '快照',
      description: '服务器记录账户状态（权益、余额、持仓）的频率。这是录制计划，不是图表筛选器。它不会改变投资组合图表显示的内容，只决定图表有多少历史数据可画。它原本就在那张图表下方，看上去像是区间选择器，这正是它现在放到这里的原因。',
    },
    persona: {
      title: '人设',
  ...
  market: {
    ...
    macroSince: '起点',
    macroClose: '关闭',
    macroFullHistory: '此面板始终显示全部历史，不受看板日期区间的影响，所以最小、最大和起点可能与卡片不一致。',
    macroBoardRange: '看板区间：{{from}} → {{to}}',
    colValue: '数值',
    noData: '暂无数据',
    showMoreResults: '显示更多结果',
    resultsTruncated: '仅显示前 {{shown}} 条匹配。缩小搜索范围可看到其余结果。',
  },
  portfolio: {
    overview: '概览',
    allAccounts: '全部账户',
  ...
  templates: {
    ...
    communityDescription:
      '第三方生态的打包模板——创建工作区时从上游仓库全新 clone，由原作者维护，而非 Lyramor。',
    communityBadge: '社区',
    agentsLabel: 'Agents',
