...
export const en = {
  ...
  settings: {
    ...
    snapshot: {
      title: 'Snapshots',
      description:
        'How often the server records the state of your account: equity, balance and open positions. This is a recording schedule, not a chart filter. It never changes what the Portfolio chart shows, it decides how much history exists for that chart to draw. It used to sit directly under the chart, where it read like a range picker, which is exactly why it lives here now.',
    },
    persona: {
      title: 'Persona',
  ...
  market: {
    ...
    macroSince: 'Since',
    macroClose: 'Close',
    macroFullHistory: 'This panel always shows the full history, not the date range picked on the board, so Min, Max and Since can differ from the card.',
    macroBoardRange: 'Board range: {{from}} â {{to}}',
    colValue: 'Value',
    noData: 'No data',
    showMoreResults: 'Show more results',
    resultsTruncated: 'Showing the first {{shown}} matches. Narrow the search to see the rest.',
  },
  portfolio: {
    overview: 'Overview',
  ...
  news: {
    ...
    rangeLabel: 'Range',
    sourceLabel: 'Source',
    widenRange: 'Show the last 7 days',
  },
  tracked: {
  ...
  templates: {
    ...
    communityDescription:
      'Bundles of third-party ecosystems — cloned fresh from their upstream repos at workspace creation and maintained by their own authors, not by Lyramor.',
