...
const inputClass =
  'w-full bg-bg border border-border rounded-lg px-3 py-2 text-[13px] text-text placeholder:text-text-muted/60 transition-colors focus:outline-none focus:border-accent focus:ring-2 focus:ring-accent/40'
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
            ...
            <div className="rounded-md border border-accent/40 bg-accent/10 text-text text-[12px] px-3 py-2.5 flex items-center justify-between gap-3">
              ...
              <div className="flex gap-2 shrink-0">
                ...
                <button
                  ...
                  disabled={savingCred}
                  className="px-2.5 py-1 rounded-lg bg-gradient-to-br from-accent to-purple text-white text-[12px] font-medium disabled:opacity-40 hover:brightness-110 transition-all"
                >
          ...
          <p className="text-[11px] text-text-muted/80 leading-snug pt-1">
            ...
            {tab === 'opencode' && ' opencode reads `opencode.json` from the workspace cwd; Lyramor injects its MCP servers at spawn.'}
          ...
          <div className="flex gap-2">
            ...
            {needsTest ? (
              <button
                ...
                className="px-4 py-2 rounded-lg bg-gradient-to-br from-accent to-purple text-white text-[13px] font-medium shadow-[0_2px_14px_var(--color-accent-dim)] disabled:opacity-40 disabled:cursor-not-allowed hover:brightness-110 transition-all"
              >
