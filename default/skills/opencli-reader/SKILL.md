...
description: >
  ...
  commands. opencli is NOT bundled with Lyramor: if it's missing and a task
...
`opencli <site> <command>` surface. Lyramor does not bundle or install it —
...
*Maintained by Lyramor. Doctrine follows the official
