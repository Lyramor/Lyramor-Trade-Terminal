...
**Capability**: knows Lyramor is open-source, has read this repo. Knows
...
**Coverage**: medium. Lyramor mandates that public deployment is behind
...
Lyramor is single-user by design. There is one "admin." We do not
